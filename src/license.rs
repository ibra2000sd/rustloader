...
fn get_machine_id() -> Result<String, AppError> {
    ...
    // This should never be reached due to the cfg blocks above
    // But we need it for the compiler as a fallback
    Err(AppError::General("Unsupported platform".to_string()))
}
